...
rootpath ="C:\\Users\\User\\OneDrive\\Desktop\\song\\"
pattern ="*.mp3"
...
listBox= tk.Listbox(canvas, fg="black",bg="red",width=150,font=('bold_roboto',15))
listBox.pack(padx=15,pady=15)

label=tk.Label(canvas,text='',bg='black',fg='yellow',font=('roboto',18))
label.pack(pady=15)
